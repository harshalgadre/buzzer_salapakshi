        ...
        <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-blue-50">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-lg p-6">
                    ...
                    {/* Dummy User Count + Table */}
                    <p className="text-black mb-3">Total Users: <span className="font-semibold text-orange-600">3</span></p>
                    <table className="min-w-full bg-white rounded-lg overflow-hidden text-black">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td className="py-2 px-4">Ayush Khalate</td>
                                <td className="py-2 px-4">ayush@example.com</td>
                                <td className="py-2 px-4">User</td>
                            </tr>
                        </tbody>
                    </table>
