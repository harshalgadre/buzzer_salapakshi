        ...
        <main className="flex-1 p-8">
          ...
          <div className="bg-orange-100 rounded-lg p-6 mb-6">
            ...
            <div className="flex space-x-4">
              <button
                ...
                className="bg-orange-600 text-white px-6 py-2 rounded-md hover:bg-orange-700 transition-colors flex items-center space-x-2"
              >
              ...
              <button
                onClick={handleClear}
                className="bg-white text-orange-600 border border-orange-600 px-6 py-2 rounded-md hover:bg-orange-50 transition-colors flex items-center space-x-2"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white rounded-lg shadow-sm">
            ...
            <div className="px-6 py-12 text-center text-gray-500">
              ...
              <p className="text-lg font-medium mb-2">No interview history found</p>
